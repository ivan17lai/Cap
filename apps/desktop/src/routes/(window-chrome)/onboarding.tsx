		...
		<div class="flex flex-col items-center justify-center min-h-full px-10 gap-8">
			...
			>
				...
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("Whether you need speed, studio quality, or a quick screenshot — Cap has a mode for it.")}
				</p>
			</div>
			...
			<div class="w-[240px] shrink-0 flex flex-col justify-center">
				...
				>
					<div class="flex items-center gap-3">
						...
						<div>
							<h3 class="text-lg font-bold text-gray-12">{t(props.mode.title)}</h3>
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 gap-8">
			...
			>
				...
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("Toggle between modes with a single click from the main Cap window.")}
				</p>
			</div>
...
function ShortcutsStep(props: { active: boolean }) {
	...
	const settingsAreas = () => [
		...
		},
		{
			...
			desc: t("Connect your own S3-compatible bucket for full control over your recordings"),
		},
		{
	...
	return (
		<div class="flex flex-col items-center justify-center min-h-full px-12 gap-6">
			...
			>
				...
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("Customize everything from keyboard shortcuts to storage. Cap adapts to your workflow.")}
				</p>
			</div>
		...
		<div class="flex flex-col items-center justify-center min-h-full px-12 py-6 gap-6">
			...
			>
				<FaqItem question={t("Is Cap free to use?")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("Cap is free for personal use. For teams and commercial use, check out our")}{" "}
						<button
							type="button"
				...
				<FaqItem question={t("What's the difference between Instant and Studio?")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("Instant mode uploads as you record — stop recording and you'll have a shareable link immediately. Studio mode records locally in full quality, letting you edit with backgrounds, effects, and more before sharing.")}
					</p>
				</FaqItem>
				<FaqItem question={t("Where are my recordings stored?")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("All recordings are stored locally on your computer. In Instant mode, they're also uploaded to Cap's cloud for easy sharing. You can manage storage in Settings.")}
					</p>
				</FaqItem>
				<FaqItem question={t("Can I change my shortcuts later?")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("Head to Settings → Shortcuts at any time to customize all your keyboard shortcuts.")}
					</p>
				</FaqItem>
				<FaqItem question={t("How does sharing work?")}>
					<p class="text-[13px] text-gray-10 leading-relaxed">
						{t("In Instant mode, you get a shareable link automatically when you stop recording. In Studio mode, export your edited video and share via Cap's cloud or save locally.")}
					</p>
				</FaqItem>
			</div>
						...
						<Show
							...
							fallback={
								<div class="flex flex-row items-center gap-1.5 rounded-lg px-2 py-1 text-gray-10">
									...
									<span class="text-[0.875rem] font-medium">{t("Stopped")}</span>
								</div>
							}
						>
							<button
	...
	return (
		...
		>
			...
			>
				...
				<p class="text-[14px] text-gray-10 leading-relaxed">
					{t("Cap needs a few permissions to record your screen and capture audio.")}
				</p>
			</div>
