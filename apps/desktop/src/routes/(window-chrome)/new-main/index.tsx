	...
	return (
		...
		>
			...
			<Show when={props.isLoading}>
				<div class="py-6 text-sm text-center text-gray-11">{t("Loading...")}</div>
			</Show>
...
function TargetMenuPanel(props: TargetMenuPanelProps & SharedTargetMenuProps) {
	...
	const settingsSubtitle = () =>
		props.variant === "camera" ? t("Camera settings") : t("Microphone settings");
						...
						<div class="flex gap-2 flex-1 min-w-0">
							...
							>
								...
								>
									...
									<span>
										{props.variant === "screenshot" ? t("Import image") : t("Import")}
									</span>
								</Button>
							</Show>
						</div>
						...
						{(variant) =>
							variant === "display" ? (
								...
								<TargetMenuPanel
									...
									errorMessage={
										recordings.error ? t("Failed to load recordings") : undefined
									}
								...
								<TargetMenuPanel
									...
									errorMessage={
										screenshots.error ? t("Failed to load screenshots") : undefined
									}
