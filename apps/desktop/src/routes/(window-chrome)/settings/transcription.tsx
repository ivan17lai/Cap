		...
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				<Section
					...
					description={t("Add names, spellings, domains, and capitalization preferences that caption generation should keep in mind.")}
				>
					<SectionCard padded class="space-y-3">
						<div class="flex items-center justify-between gap-3">
							<div class="flex flex-col gap-0.5 min-w-0">
								...
								<p class="text-xs leading-snug text-gray-10">
									{t("Add one term at a time to reduce typos and formatting mistakes.")}
								</p>
							</div>
						...
						<p class="text-xs leading-relaxed text-gray-10">
							{t("These hints are applied when you generate captions in the editor.")}
						</p>
					</SectionCard>
				</Section>
