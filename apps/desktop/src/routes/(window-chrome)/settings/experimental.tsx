				...
				<Show
					...
					fallback={
						<p class="text-xs leading-relaxed text-gray-10 px-1">
							{t("No experimental features are currently available on this platform.")}
						</p>
					}
				>
					<Section title={t("Preview")}>
						<SectionRows>
							<ToggleSettingItem
								...
								description={t("Render the camera preview using a native GPU surface instead of through the webview. Not stable on certain Windows systems.")}
				...
				<Section title={t("Reliability")}>
					<SectionRows>
						<ToggleSettingItem
							...
							description={t("Run the fragmented-MP4 muxer in an isolated subprocess so muxer crashes can't take down your recording. Requires the bundled cap-muxer binary.")}
