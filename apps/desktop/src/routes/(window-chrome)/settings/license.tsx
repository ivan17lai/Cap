				...
				{(generalSettings) => {
					...
					return (
						<div class="p-6 mx-auto w-full rounded-xl border text-gray-12 bg-gray-2 border-gray-3">
							<div class="space-y-3">
								<h3 class="mb-2 text-xl text-center">{t("Have a license key?")}</h3>
								<Input
					...
					>
						...
						<div class="flex flex-col justify-center items-center mt-5">
							...
							<p class="text-[16px] font-medium text-gray-11">
								{isCommercialAnnual() ? t("billed annually") : t("one-time payment")}
							</p>
						</div>
						<div
						...
						>
							<p class="text-xs text-gray-12">
								{t("Switch to")} {isCommercialAnnual() ? t("lifetime") : t("yearly")}:{" "}
