	...
	return (
		<div class="cap-settings-page flex flex-col h-full custom-scroll">
			<SettingsPageContent>
				...
				<Section
					title={t("Connection")}
					description={t("Google Drive stores new uploads in a private Cap folder in your Drive. Existing Cap-hosted and S3 videos keep using their current storage.")}
				>
									...
									>
										<Show when={storageQuota()}>
											<div class="pt-3 space-y-2 border-t border-gray-3">
												<div class="flex justify-between items-start gap-4">
													<div class="flex flex-col gap-0.5 min-w-0">
														<p class="text-[13px] text-gray-12">{t("Storage")}</p>
