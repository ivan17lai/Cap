								...
								<div class="flex flex-col items-center">
									...
									<Show when={!isValid()}>
										<div class="flex flex-col gap-1 items-center p-2.5 my-2 rounded-xl border min-w-fit w-fit bg-red-2 shadow-xs border-red-4 text-sm">
											<p>
												{t("Minimum size is")} {minSize().width} x {minSize().height}
											</p>
											<small>
												<code>
					...
					<Show
						...
						fallback={
							<div class="flex flex-col items-center gap-2 text-center px-4">
								...
								<div class="text-sm text-gray-11">{t("Please select a camera")}</div>
							</div>
						}
					>
						<Show
						...
						>
							<Show
								when={frame()}
								fallback={
									<div class="text-sm text-gray-11">{t("Loading camera...")}</div>
								}
							>
