...
export function OrganizationDropdown() {
	...
	const fallbackTitle = createMemo(() => {
		...
		if (availability === "unavailable") return t("Unable to load organizations");
	...
	const fallbackDescription = createMemo(() => {
		...
		if (availability === "unavailable") {
			return t("Organization branding uses live Cap web data. Connect to Cap web to select an organization and use its colours.");
		}
		return t("Sign in to select an organization, edit brand colours, and use those colours in Studio.");
	});
