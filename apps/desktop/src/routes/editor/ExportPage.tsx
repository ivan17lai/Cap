			...
			<div class="flex-1 min-h-0 flex relative">
				<div class="flex-1 min-h-0 p-5 flex flex-col">
					<div class="flex items-center gap-1.5 mb-2">
						...
						<Tooltip content={t("This is a rendered frame from your video. Adjust the settings below to see the quality of the final exported video.")}>
				...
				<div class="w-[400px] border-l border-gray-3 flex flex-col bg-gray-1 dark:bg-gray-2">
					<div class="flex-1 overflow-y-auto p-4 space-y-5">
						<Field name={t("Destination")} icon={<IconCapUpload class="size-4" />}>
								...
								<For each={EXPORT_TO_OPTIONS}>
									{(option) => {
										...
										const disabledReason = () =>
											isDisabled()
												? cursorOnly()
													? t("Cursor-only exports can only be saved to a file or clipboard")
													: t("Transparent exports can only be saved to a file or clipboard")
												: undefined;
										const button = (
											<button
												type="button"
											...
											>
												...
												/>
												<span class="text-xs font-medium">{t(option.label)}</span>
											</button>
										);
						...
						<Field name={t("Frame Rate")} icon={<IconLucideGauge class="size-4" />}>
							<div class="flex gap-1.5">
								...
								>
									...
									<div class="text-left">
										...
										<span class="text-[10px] text-gray-9">
											{t("Re-encodes with software for much smaller files (slower)")}
										</span>
									</div>
								</button>
							</Field>
						...
						>
							...
							>
								<span>{advancedMode() ? t("Hide options") : t("Show options")}</span>
								<IconCapChevronDown
									class={cx(
											...
											<Show when={ostype() === "macos"}>
												<div class="mt-4 pt-3 border-t border-gray-4">
													...
													>
														...
														<div class="text-left">
															<span class="block">{t("Force FFmpeg decoder")}</span>
															<span class="text-[10px] text-gray-9">
										...
										<Switch>
											...
											<Match when={uploadState.type === "done"}>
												<CompletedExport
													...
													subtitle={t("Your Cap has been uploaded successfully")}
												/>
											</Match>
										</Switch>
									)}
